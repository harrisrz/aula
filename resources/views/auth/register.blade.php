              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukkan Data Anda Untuk Membuat Akun Baru</p>
                  </div>

                  <form action="{{route('register-proses')}}" method="post" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="invalid-feedback">Masukka Password!</div>
                    </div>
